...
const services = [
  ...
  },
  {
    ...
    desc: `Vehicle diagnostics use advanced tools to detect issues with the engine, transmission.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Car repairs",
    desc: `Services performed to fix mechanical, electrical, ensuring it runs smoothly and safely.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[85%] mt-25 rounded-2xl mx-auto h-30 object-cover"
                    onError={(e) => {
